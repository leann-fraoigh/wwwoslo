...
// // Click on buttons
// var button = document.querySelector('.score__pagination-button--1');
// button.addEventListener('click', createChart);

// var button2 = document.querySelector('.score__pagination-button--2');
// button2.addEventListener('click', createChart);

// var button3 = document.querySelector('.score__pagination-button--3');
// button3.addEventListener('click', createChart);

// var button3 = document.querySelector('.score__pagination-button--4');
// button3.addEventListener('click', createChart);

// // Add eventListeners to all buttons
// for (var i = 0; i < buttons.length; i++) {
//   buttons[i].addEventListener('click', createChart);
// }
